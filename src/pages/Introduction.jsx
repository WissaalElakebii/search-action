    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Box component="header" sx={{ mb: 4, textAlign: 'center' }}>
        ...
        <Typography variant="h5" component="h2" sx={{ fontStyle: 'italic', color: 'text.secondary' }}>
          Guide pratique pour mener une recherche en sciences de l’éducation
        </Typography>
      </Box>
      ...
      <Box component="section" sx={{ mb: 4 }}>
        <Typography paragraph>
          La recherche en éducation est une démarche <strong>systématique et réfléchie</strong> visant à comprendre les phénomènes liés à l’enseignement et à l’apprentissage. 
          Elle permet d’analyser les pratiques pédagogiques, d’identifier les difficultés des apprenants et de proposer des solutions adaptées pour améliorer la qualité de l’éducation.
        </Typography>
        <Typography paragraph>
          Ce guide vous accompagne à travers les différentes étapes de la recherche : 
          <strong> Problématique → Méthodologie → Collecte des données → Analyse → Interprétation → Conclusion</strong>.
        </Typography>
        <Typography>
        ...
        <List>
          ...
          <ListItem>
            <ListItemText 
              ...
              secondary="Respect des apprenants, confidentialité et responsabilité pédagogique" 
            />
          </ListItem>
          <ListItem>
            <ListItemText 
        ...
        <List component="ol" sx={{ listStyleType: 'decimal', pl: 4 }}>
          <ListItem sx={{ display: 'list-item' }}>
            <ListItemText 
              ...
              secondary="Identifier un problème pédagogique ou éducatif pertinent" 
            />
          </ListItem>
          <ListItem sx={{ display: 'list-item' }}>
            <ListItemText 
